            ...
            <View style={styles.infoBox}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.text}>
                        Una plaga de "Bugs" está destruyendo el código fuente. Tu misión es eliminarlos antes de que el sistema colapse.
                    </Text>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.text}>
                        Los objetivos aumentarán su velocidad y reducirán su tamaño de forma proporcional a tu éxito.
                    </Text>
                </View>
